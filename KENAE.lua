...
{
{text = ''..(channel_ts or "KENAE TEAM")..'', url=''..(channel_user_ts or 't.me/KENAE_TM')..''},
},
}
...
info = '💬┊اهلا عزيزي ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'KENAE_TM')..')\n'..text
...
info = '👤┊العضو ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'KENAE_TM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '👤┊العضو ~⪼ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'KENAE_TM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '💬┊اهلاعزيزي ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'KENAE_TM')..')\n'..text
...
if (text == "قفل التاك") then
  ...
  if tsX_o then
  tsX000("lock",msg,"🔖※  تم **تفعیل** قفل التاك ✓")
  else
  tsX000("lock",msg,"🔖※  تم بالفعل **تفعیل** قفل التاك ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🔗※ تم بالفعل **تفعيل** قفل الشارحه ✓")
  else
  tsX000("lock",msg,"🔗※ تم  **تفعيل** قفل الشارحه ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🕹※ تم بالفعل **تفعيل** اللعبه ✓")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"✏※ تم بالفعل **تفعيل** قفل التعديل ✓")
  else
  tsX000("lock",msg,"✏※ تم **تفعيل** قفل التعديل ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"➿※ تم بالفعل **تفعيل** قفل التكرار ✓")
  else
  tsX000("lock",msg,"➿※ تم **تفعيل** قفل التكرار ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"📽※ تم بالفعل **تفعيل** قفل المتحركه ✓")
  else
  tsX000("lock",msg,"📽※ تم **تفعيل** قفل المتحركه ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🗂※ تم بالفعل **تفعيل** قفل الملفات ✓")
  else
  tsX000("lock",msg,"🗂※ تم **تفعيل** قفل الملفات ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"♾※ تم بالفعل **تفعيل** قفل الماركدون ✓")
  else
  tsX000("lock",msg,"♾※ تم **تفعيل** قفل الماركدون ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"📷※ تم بالفعل **تفعيل** قفل الصور ✓")
  else
  tsX000("lock",msg,"📷※ تم **تفعيل** قفل الصور ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🤶※ تم بالفعل **تفعيل** قفل الملصقات ✓")
  else
  tsX000("lock",msg,"🤶※ تم **تفعيل** قفل الملصقات ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"📹※ تم بالفعل **تفعيل** قفل الفيديو ✓")
  else
  tsX000("lock",msg,"📹※ تم **تفعيل** قفل الفيديو ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🌐※ تم بالفعل **تفعيل** قفل الانلاين ✓")
  else
  tsX000("lock",msg,"🌐※ تم **تفعيل** قفل الانلاين ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"💌※ تم بالفعل **تفعيل** قفل الدردشه ✓")
  else
  tsX000("lock",msg,"💌※ تم **تفعيل** قفل الدردشه ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"📲※ تم بالفعل **تفعيل** قفل التوجيه ✓")
  else
  tsX000("lock",msg,"📲※ تم **تفعيل** قفل التوجيه ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🔱※ تم بالفعل **تفعيل** قفل التثبيت ✓")
  else
  tsX000("lock",msg,"🔱※ تم **تفعيل** قفل التثبيت ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🎧※ تم بالفعل **تفعيل** قفل الاغاني ✓")
  else
  tsX000("lock",msg,"🎧※ تم **تفعيل** قفل الاغاني ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🎤※ تم بالفعل **تفعيل** قفل الصوت ✓")
  else
  tsX000("lock",msg,"🎤※ تم **تفعيل** قفل الصوت ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"☎️※ تم بالفعل **تفعيل** قفل جهات ✓")
  else
  tsX000("lock",msg,"☎️※ تم **تفعيل** قفل جهات ✓")
  ...
  if tsX_o then
    tsX000("lock",msg,"📋※ تم بالفعل **تفعيل** قفل العربيه ✓")
  else
  tsX000("lock",msg,"📋※ تم **تفعيل** قفل العربيه ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🔠※ تم بالفعل **تفعيل** قفل الانكليزي ✓")
  else
  tsX000("lock",msg,"🔠※ تم **تفعيل** قفل الانكليزي ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"📺※ تم بالفعل **تفعيل** قفل المديا ✓")
  else
  tsX000("lock",msg,"📺※ تم **تفعيل** قفل المديا ✓")
...
database:set("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  ...
  if tsX_o then
    tsX000("lock",msg,"🔖※ تم بالفعل **تفعيل** قفل الروابط ✓")
  else
  tsX000("lock",msg,"🔖※ تم **تفعيل** قفل الروابط ✓")
  ...
  if tsX_o then
    tsX000("lock",msg,"📑※ تم بالفعل **تفعيل** قفل الفشار ✓")
  else
  tsX000("lock",msg,"📑※ تم **تفعيل** قفل الفشار ✓")
  ...
  if tsX_o then
   tsX000("lock",msg,"🎅※ تم بالفعل **تفعيل** قفل المعرف ✓")
  else
  tsX000("lock",msg,"🎅※ تم **تفعيل** قفل المعرف ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"💭※ تم بالفعل **تفعيل** قفل الاشعارات ✓")
  else
  tsX000("lock",msg,"💭※ تم **تفعيل** قفل الاشعارات ✓")
  ...
  if tsX_o then
   tsX000("lock",msg,"🤖※ تم بالفعل **تفعيل** قفل البوتات بالطرد ✓")
  else
  tsX000("lock",msg,"🤖※ تم **تفعيل** قفل البوتات بالطرد ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🤖※ تم بالفعل **تفعيل** قفل البوتات ✓")
  else
  tsX000("lock",msg,"🤖※ تم **تفعيل** قفل البوتات ✓")
  ...
  if tsX_o then
  tsX000("lock",msg,"🔅※ تم بالفعل **تفعيل** قفل بصمه فيديو ✓")
  else
  tsX000("lock",msg,"🔅※ تم **تفعيل** قفل بصمه فيديو ✓")
  database:set("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  end
  end
  --         »»                 End KENAE lock                         ««              --
  ...
  local tsX_o = database:get("lock_new:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الاشعارات ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الاشعارات ✓")
  ...
  local tsX_o = database:get("lock_tag:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل التاك ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل التاك ✓")
  ...
  local tsX_o = database:get("lock_sarha:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الشارحه ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الشارحه ✓")
  ...
  local tsX_o = database:get("lock_lllll:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل التكرار ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل التكرار ✓")
  ...
  local tsX_o = database:get("lock_gif:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل المتحركه ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل المتحركه ✓")
  ...
  local tsX_o = database:get("lock_files:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الملفات ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الملفات ✓")
  ...
  local tsX_o = database:get("lock_mark:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الماركدون ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الماركدون ✓")
  ...
  local tsX_o = database:get("lock_photo:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الصور ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الصور ✓")
  ...
  local tsX_o = database:get("lock_stecker:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الملصقات ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الملصقات ✓")
  ...
  local tsX_o = database:get("lock_video:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الفيديو ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الفيديو ✓")
  ...
  local tsX_o = database:get("lock_inline:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الانلاين ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الانلاين ✓")
  ...
  local tsX_o = database:get("lock_chat:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الدردشه ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الدردشه ✓")
  ...
  local tsX_o = database:get("lock_fwd:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل التوجيه ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل التوجيه ✓")
  ...
  local tsX_o = database:get("lock_pin:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل التثبيت ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل التثبيت ✓")
  ...
  local tsX_o = database:get("lock_audeo:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الاغاني ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الاغاني ✓")
  ...
  local tsX_o = database:get("lock_voice:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الصوت ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الصوت ✓")
  ...
  local tsX_o = database:get("lock_botAndBan:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل البوتات بالطرد ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل البوتات بالطرد ✓")
  ...
  local tsX_o = database:get("lock_contact:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الجهات ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الجهات ✓")
  ...
  local tsX_o = database:get("lock_ar:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل العربيه ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل العربيه ✓")
  ...
  local tsX_o = database:get("lock_en:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الانكليزيه ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الانكليزيه ✓")
  ...
  local tsX_o = database:get("lock_media:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل المديا ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل المديا ✓")
...
database:del("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  ...
  local tsX_o = database:get("lock_username:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل المعرف ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل المعرف ✓")
  ...
  local tsX_o = database:get("gamee:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** اللعبه ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** اللعبه ✓")
  ...
  local tsX_o = database:get("lock_note:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل بصمه فيديو ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل بصمه فيديو ✓")
  database:del("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  local tsX_o = database:get("lock_link:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الروابط ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الروابط ✓")
  ...
  local tsX_o = database:get("fshar:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل الفشار ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل الفشار ✓")
  ...
  local tsX_o = database:get("lock_bot:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"※ تم بالفعل **تعطیل** قفل البوتات ✓")
  else
  tsX000("lock",msg,"※ تم **تعطیل** قفل البوتات ✓")
...
tsX000("prore",msg,"※ بالتأكيد تم رفعه منشئ في البوت ✓ 👨🏻‍✈️")
else
database:sadd(hash, result.sender_user_id_)
tsX000("prore",msg,"※ تم رفعة منشئ في البوت ✓ 👨🏻‍✈️")
end
end
...
texts = '👤┊العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'KENAE_TM')..')\n※ تم رفعة منشئ في البوت ✓ 👨🏻‍✈️'
else
texts = '✖┊خطاء'
end
...
database:sadd('KENAE:'..bot_id..'creator:'..msg.chat_id_, apow[2])
  tsX000(apow[2],msg,"※ تم رفعة منشئ في البوت ✓ 👨🏻‍✈️")
end
if text:match("^تنزيل منشئ$") and msg.reply_to_message_id_ then
function decreator_by_reply(extra, result, success)
local hash =  'KENAE:'..bot_id..'creator:'..msg.chat_id_
if not database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"👨🏻‍✈️※ بالتأكيد تم تنزيله من منشئين البوت ✓ ")
else
database:srem(hash, result.sender_user_id_)
tsX000("prore",msg,"👨🏻‍✈️※  تم تنزيله من منشئين البوت ✓ ")
end
end
...
database:srem(hash, apow[2])
  tsX000(apow[2],msg,"👨🏻‍✈️※  تم تنزيله من منشئين البوت ✓ ")
end--
...
os.execute('cd libs && wget https://raw.githubusercontent.com/KENAEi/KENAE/master/libs/utils.lua')
os.execute('rm -rf KENAE.lua')
os.execute('wget https://raw.githubusercontent.com/KENAEi/KENAE/master/KENAE.lua')
os.exit()
return false
end
...
local kkt = ''
if start then 
kkt = start.. "\n[🦁┇KENAE TEAM](https://t.me/KENAE_TM)" -- هلو ماوصيك 
else 
...
function res_by_username(extra, result, success)
 ...
 local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
  ...
  database:srem(hash, result.id_)
  texts = '👤┊العضو ~⪼ ['..result.title_..'](t.me/'..(apsi[2] or 'KENAE_TM')..')'\n تم الغاء تقيد العضو ✓'
  else
  texts = '✖️┊خطاء'
  end
  send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
  ...
  texts = '👤┊العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'KENAE_TM')..')\n🚦┊تم رفعه ادمن'
  else
  texts = '✖┊خطاء'
  end
  send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
tsX000("prore",msg,"🚦┊بالتأكيد تم رفعه عضو مميز") 
 ...
 chat_kick(result.chat_id_, result.sender_user_id_)
  ...
  send(msg.chat_id_, msg.id_, 1, '❕┊لا تستطيع حظر \n🔘┊(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
      ...
      texts = '👤┊العضو ~⪼ ['..result.title_..'](t.me/'..(apba[2] or 'KENAE_TM')..')\n🚦┊تم حظره من المجموعه'
  ...
  send(msg.chat_id_, msg.id_, 1, '❕┊لا تستطيع حظر عام \n🔘┊(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
    ...
    local hash =  'KENAE:'..bot_id..'gbanned:'
  texts = '👤┊العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'KENAE_TM')..')\n🚫┊تم حظره من المجموعات البوت'
  ...
  function ungban_by_username(extra, result, success)
    local hash =  'KENAE:'..bot_id..'gbanned:'
    if result.id_ then
  texts = '👤┊العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'KENAE_TM')..')\n🚫┊تم فك حظره من المجموعات البوت'
  database:srem(hash, result.id_)
    else
    texts = '✖┊خطاء'
    end
...
tsX000(apsi[2],msg,"🚫┊تم كتمه من البوت")
  ...
  send(msg.chat_id_, msg.id_, 1, '✖┊لا تستطيع طرد \n🔘┊(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
    ...
    texts = '👤┊العضو ~⪼ ['..result.title_..'](t.me/'..(apki[2] or 'KENAE_TM')..')\n🚫┊تم طرده من المجموعه'
       chat_kick(msg.chat_id_, result.id_)
    end
  else
    texts = '✖┊خطاء'
...
taha = '*💎¦ ليس لديك مجوهرات \n📬¦ للحصول على مجوهرات ارسل `الاسرع` `حزوره` `سمايلات` وابدأ اللعب*\n'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
else
